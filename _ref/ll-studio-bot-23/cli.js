...
const liveStillBot = require('./src/ll-bots/live-still-bot/watcher')
const img2mdBot = require('./src/ll-bots/live-still-bot/img2md-watcher')
...
} else if (yargs.liveStillFolder) {
    liveStillBot(yargs.liveStillFolder)
} else if (yargs.liveImg2mdFolder) {
    img2mdBot(yargs.liveImg2mdFolder)
} else if (yargs.v2s) {
