...
module.exports = function(draftEvent) {
  ...
  var revisedEvent = {
      ...
      "text": {
        "headline": draftEvent.fields.Value,
        "text": `reference to a ${draftEvent.fields.Value} at ${draftEvent.fields.AirtableCreatedTime} in channel ${draftEvent.fields.ChannelName}.  If it was made by a user, that user's name is ${draftEvent.fields.UserName}`
      }
  }
